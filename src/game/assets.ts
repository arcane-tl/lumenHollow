...
export async function loadImages(): Promise<GameImages> {
  const [
    ...
    load("/game/map/sky.png?v=hd5"),
    load("/game/map/far.png?v=hd5"),
    load("/game/map/mid.png?v=hd5"),
    load("/game/map/near.png?v=hd7"),
    load("/game/map/thorn-sky.png"),
    load("/game/map/thorn-far.png"),
    load("/game/map/thorn-mid.png"),
    load("/game/map/thorn-near.png"),
    load("/game/map/cinder-sky.png?v=hd3"),
    load("/game/map/cinder-far.png?v=hd3"),
    load("/game/map/cinder-mid.png?v=hd3"),
    load("/game/map/cinder-near.png?v=hd3"),
